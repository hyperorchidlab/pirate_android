...
public class Constants {
    ...
    public static final int BLOCK_PACKING_TIME = 40;
    public static final int QUERY_TX_STATUS = 10;
    ...
    public static final int REQUEST_OWNE_MINE_POOL_ERROR = 404;
    ...
    public static final int REQUEST_BYTESPERTOKEN_ERROR = 4012;
    public static final int REQUEST_OPEN_WALLET_ERROR = 4013;
    public static final int REQUEST_TIME_OUT = 4040;
